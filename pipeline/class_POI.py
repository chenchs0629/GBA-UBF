...
# 读取 CSV 文件
df = pd.read_csv("C:/Users/chenchs/Desktop/POI_ori/中山POI数据11.1/POI_clip.csv")  # 替换为你的实际路径
...
# 保存处理结果
df.to_csv("C:/Users/chenchs/Desktop/POI_ori/中山POI数据11.1/POI_clip_Label.csv", index=False, encoding='utf-8-sig')
